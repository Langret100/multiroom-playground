...
ok(src.includes("localUsePendingSeq=input.useSeq>>>0")&&src.includes("localUsePendingUntil=Number.MAX_SAFE_INTEGER"),'guest use is not ACK-gated until authoritative confirmation');
...
ok(src.includes('predictedRespawnAck')&&src.includes('if(predictedRespawnAck){const prevY='),'predicted respawn ACK reconciliation missing');
