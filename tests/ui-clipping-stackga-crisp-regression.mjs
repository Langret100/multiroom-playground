...
ok(idx.includes('game.css?v=20260831-jellyfocus4') && idx.includes('main.js?v=20260831-jellyfocus4'),'stackga cache bust missing');
ok(room.includes('styles.css?v=20260831-roomguide3'),'room css cache bust missing');
