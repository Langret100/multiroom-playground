...
ok(game.includes('Soft night-sky board'),'night sky render missing');
ok(game.includes('cell*.008'),'jelly cell gap not tightened enough');
...
ok(idx.includes('game.css?v=20260831-jellyfocus5') && idx.includes('main.js?v=20260831-jellyfocus5'),'stackga cache bust missing');
ok(room.includes('styles.css?v=20260831-roomguide4'),'room css cache bust missing');
