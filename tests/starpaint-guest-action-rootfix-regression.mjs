...
ok(src.includes("if(seq32Newer(useSeq,p.lastUseSeq)){p.lastUseSeq=useSeq;useItem(p)}"),'monotonic one-shot use gate missing');
ok(!src.includes("parent.postMessage({type:'pb_input',gameId:'starpaint'"),'duplicate guest action transport remains');
