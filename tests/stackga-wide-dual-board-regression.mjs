...
ok(main.includes('./touch.js?v=20260831-jellyfocus5'), 'touch cache bust missing');
ok(html.includes('game.css?v=20260831-jellyfocus5') && html.includes('main.js?v=20260831-jellyfocus5'), 'asset cache bust missing');
