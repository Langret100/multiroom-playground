...
ok(main.includes('./touch.js?v=20260831-nightduel2'), 'touch cache bust missing');
ok(html.includes('game.css?v=20260831-nightduel2') && html.includes('main.js?v=20260831-nightduel2'), 'asset cache bust missing');
