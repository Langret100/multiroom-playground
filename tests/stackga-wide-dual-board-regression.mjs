...
ok(main.includes('./touch.js?v=20260831-jellyfocus4'), 'touch cache bust missing');
ok(html.includes('game.css?v=20260831-jellyfocus4') && html.includes('main.js?v=20260831-jellyfocus4'), 'asset cache bust missing');
