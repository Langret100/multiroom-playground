(function(){
  ...
  const GAME_REGISTRY = [
...

    {
      id: "soccer",
      name: "수학축구",
      mobileHint: "모바일: 조이스틱 이동 · 킥 버튼(누르면 강슛 충전) · 돌진 버튼(태클)",
      pcHint: "PC: WASD/방향키 이동 · Space 누르고 있으면 강슛 충전 · Shift 돌진 태클",
      descLines: [
        "짝수 인원(2·4·6·8명)이 RED와 BLUE 두 팀으로 나뉘어 2분 동안 축구 대결을 합니다.",
        "첫 시작 전 10초 동안 초등 3학년 수준의 두 자리 덧셈·뺄셈을 계속 풀어 팀 정답 합계로 첫 선공을 정합니다.",
        "골이 들어가면 5초짜리 재시작 문제 대결이 열리고, 한 팀 전원이 먼저 각자 문제를 해결하면 그 팀이 선공합니다.",
        "5초 안에 두 팀 모두 전원 해결에 실패하면 해결한 팀원 수가 많은 팀이 선공하고, 동점이면 동전 던지기로 결정합니다.",
        "정답을 누르면 바로 다음 문제로 넘어가고, 오답은 X 표시가 두 번 깜빡이며 0.6초 뒤 같은 문제를 다시 풀게 됩니다.",
        "팀마다 캐릭터 6종 중 하나가 경기 시작 때 무작위로 배정되며, 모든 참가자의 화면에 동일하게 표시됩니다.",
        "문제 화면 동안 경기 시간은 잠시 멈추며, 킥 충전 강슛·헤딩·태클을 활용해 더 많은 골을 넣으면 승리합니다.",
      ],
      type: "coop",
      badgeClass: "coop",
      maxClients: 8,
